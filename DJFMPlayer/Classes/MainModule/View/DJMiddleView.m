...
#import "CALayer+DJPauseAimate.h"

@interface DJMiddleView ()
...
@implementation DJMiddleView

static DJMiddleView *_shareInstance;

+ (instancetype)shareInstance{
    if (_shareInstance == nil) {
        _shareInstance = [DJMiddleView middleView];
    }
    return _shareInstance;
}

+ (instancetype)middleView{
    DJMiddleView *middleView = [[NSBundle mainBundle] loadNibNamed:@"DJMiddleView" owner:nil options:nil].firstObject;
    return middleView;
}
